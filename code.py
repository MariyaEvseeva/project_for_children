...
class Window(QWidget):
    ...
    def initUI(self):
        ...
        self.image_name.move(1370, 20)
        self.image_name.resize(407, 50)
        self.image_name.setPixmap(self.pixmap_name)
        self.pixmap_name.load("name.png")
        self.image_name.setPixmap(self.pixmap_name)

        self.btn = QPushButton('▶ Произнести слово', self)
        self.btn.resize(300, 40)
        self.btn.move(600, 130)
        self.btn.setStyleSheet("background-color: #12C6B4; color: #F7F38D")
        self.btn.clicked.connect(self.say_word)
        ...
        self.btn = QPushButton('Нажми сюда, когда введёшь слово', self)
        self.btn.resize(490, 40)
        ...
        self.btn_2 = QPushButton('Нажми сюда, чтобы посмотреть морфологические признаки', self)
        self.btn_2.resize(860, 50)
        self.btn_2.move(1050, 120)
        self.btn_2.setStyleSheet("background-color: #12C6B4; color: #F7F38D")
        ...
        self.btn_3 = QPushButton('Нажми сюда, чтобы сделать фонетической разбор уникальных звуков', self)
        self.btn_3.resize(976, 50)
        self.btn_3.move(35, 490)
        self.btn_3.setStyleSheet("background-color: #12C6B4; color: #F7F38D")
    ...
    def transcription(self):
        ...
        if len([i for i in word if i in 'qwertyuioplkjhgfdsazxcvbnm']) != 0:
            ...
            if trnscrpt == '[]':
                trnscrpt = ''
                color = "background-color: #7FFFD4; color: #8B0000"
                self.label1.setStyleSheet(color)
    ...
    def give_info(self):
        ...
        if len([symbol for symbol in word_to_info if \
                symbol in '`~1234567890!@#$%^&*()_-=+\|]}[{,<.>/?' or \
                symbol.isalpha() == False]):
            ...
            an = set([i for i in word_to_info if i \
        ...
        if len([1 for symbol in word_to_info if symbol in \
                [chr(i) for i in range(ord('a'), ord('z') + 1)]]) != 0:
            ...
            color = "background-color: #E69898; color: #8B0000"
            color_2 = "background-color: #E69898; color: #8B0000"
            ...
            self.label_morph9.setStyleSheet(color_2)
            self.label_morph10.setStyleSheet(color)
            self.label_sounds1.setStyleSheet(color_2)
            self.label_sounds2.setStyleSheet(color)
            self.label_sounds3.setStyleSheet(color_2)
            self.label_sounds4.setStyleSheet(color)
            self.label_sounds5.setStyleSheet(color_2)
            self.label_sounds6.setStyleSheet(color)
            self.label_sounds7.setStyleSheet(color_2)
            self.label_sounds8.setStyleSheet(color)
            self.label_sounds9.setStyleSheet(color_2)
            self.label_sounds10.setStyleSheet(color)
            self.label_sounds11.setStyleSheet(color_2)
            ...
            color = "background-color: #7FFFD4; color: #007A7A"
            self.label_l.setStyleSheet(color)
            ...
            self.label_morph8.setStyleSheet(color)
            self.label_morph9.setStyleSheet(color)
            self.label_morph10.setStyleSheet(color)
            ...
            self.label_sounds10.setStyleSheet(color)
            self.label_sounds11.setStyleSheet(color)
            ...
            if len([i for i in word_to_info if i \
                    in '`~1234567890!@#$%^&*()_ -+=\|]}[{;:"/?.><,' or i == "'"]) != 0:
                ...
                color = "background-color: #E69898; color: #8B0000"
                color_2 = "background-color: #7FFFD4; color: #007A7A"
...
class Window_for_person_with_disabilities(QWidget):
    ...
    def initUI(self):
        ...
        sound_color = "background-color: #FDE9C3; color: #A8532F; font-size: 23pt"
    ...
    def give_info(self):
        ...
        if word == '':
            ...
            color_3 = "background-color: #FDE9C3; color: #A8532F; font-size: 23pt"
            ...
            color_3 = "background-color: #FDE9C3; color: #A8532F; font-size: 22pt"
            self.label_sounds1.setStyleSheet(color_3)
            self.label_sounds2.setStyleSheet(color_3)
            self.label_sounds3.setStyleSheet(color_3)
            self.label_sounds4.setStyleSheet(color_3)
